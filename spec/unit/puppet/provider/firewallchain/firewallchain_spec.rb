...
# Completed on Thu Aug 10 10:21:55 2023
      ...
      let(:returned_data) do
        [{ name: 'INPUT:nat:IPv4', purge: false, ignore_foreign: false, ensure: 'present', policy: 'accept' },
         ...
         { name: 'INPUT_END_ACL:nat:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:mangle:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:filter:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:raw:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:rawpost:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:broute:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
         ...
         { name: 'INPUT_END_ACL:security:IPv4', purge: false, ignore_foreign: false, ensure: 'present' },
