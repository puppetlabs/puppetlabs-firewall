  ...
  it 'contains appropriate rules' do
    shell('iptables-save') do |r|
      [
        ...
        /-A INPUT -d 127.0.0.0\/(8|255\.0\.0\.0) (! -i|-i !) lo --reject-with icmp-port-unreachable -m comment --comment \"011 reject local traffic not on loopback interface\" -j REJECT/,
